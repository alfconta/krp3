...
---------------------------------------- 4) EMPIEZA LA UNION
                            ...
                            (
                                    ...
                                    ,(sm.product_qty *0)as v_entrada,(am.amount_total_signed )v_salida,(sm.product_qty  *0)v_saldo,
                                     sm.state,sm.origin,sm.reference ,sl.usage,sl.complete_name,(sm.location_id)as ubicacion,sm.create_uid,sm.inventory_id,sm.picking_id 
                            ...
                            (
                               select * from (
                                    ...
                                    svl.create_date  AT TIME ZONE 'UTC' AT TIME ZONE '"""+zh+"""' as date_expected,
                                    ...
                                    ,(sm.location_id)as ubicacion,sm.create_uid,sm.inventory_id,sm.picking_id 
                                            ...
                                            LEFT join stock_picking sp on sm.picking_id=sp.id
                                            LEFT join res_users ru on svl.create_uid=ru.id
                                            LEFT join res_partner rp on rp.id=ru.partner_id
